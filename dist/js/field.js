...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mounted: function mounted() {
        if (this.field.recursive) this.watchComponentsRecursively(this.$root);else this.watchParentComponents();
    },
    ...
    methods: {
        ...
        updateOptions: function updateOptions() {
            ...
            if (this.parentValue != null && this.parentValue != "") {
                Nova.request().get("/nova-vendor/child-select/options?resource=" + this.resourceName + "&attribute=" + this.field.attribute + "&parent=" + this.parentValue + "&recursive=" + this.field.recursive).then(function (response) {
                    _this2.loaded = true;
                    _this2.options = response.data;
                    var optionValueExists = false;
                    _this2.options.forEach(function (option) {
                        if (option.value == _this2.field.value) {
                            optionValueExists = true;
                            _this2.value = option.value;
                        }
                    });
                });
            }
        ...
        isWatchingComponent: function isWatchingComponent(component) {
            return component.field !== undefined && component.field.attribute == this.field.parentAttribute;
        },
        watchParentComponents: function watchParentComponents() {
            var _this3 = this;

            this.$parent.$children.forEach(function (component) {
                _this3.watchIfParent(component);
            });
        },
        watchComponentsRecursively: function watchComponentsRecursively(root) {
            var _this4 = this;

            var _this = this;
            root.$children.forEach(function (component) {
                _this4.watchIfParent(component);
                _this4.watchComponentsRecursively(component);
            });
        },
        watchIfParent: function watchIfParent(component) {
            var _this5 = this;
            ...
            if (this.isWatchingComponent(component)) {
                ...
                component.$watch(attribute, function (value) {
                    _this5.parentValue = value && attribute == "selectedResource" ? value.value : value;
